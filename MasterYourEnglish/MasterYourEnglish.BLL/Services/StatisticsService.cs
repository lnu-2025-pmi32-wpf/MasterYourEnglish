namespace MasterYourEnglish.BLL.Services
{
    ...
    public class StatisticsService : IStatisticsService
    {
        ...
        {
            this.logger.LogInformation("Getting attempt history for user {UserId}", userId);
            try
            {
            ...
            {
                this.logger.LogError(ex, "Error getting attempt history for user {UserId}", userId);
                throw;
            }
        }
        ...
        {
            this.logger.LogInformation("Getting statistics summary for user {UserId}", userId);
            try
            {
            ...
            {
                this.logger.LogError(ex, "Error getting statistics summary for user {UserId}", userId);
                throw;
            }
        }
    }
